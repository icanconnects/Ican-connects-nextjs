...
export default function Home() {
  return (
    <main>
      {/* Hero Section */}
      <section className='relative bg-gradient-to-r from-slate-900 to-blue-900 text-white py-20 md:py-32'>
        <div className='max-w-6xl mx-auto px-4 text-center'>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-4'>
            <Link href='/membership' className='px-6 py-3 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 transition'>Become a Member</Link>
            <Link href='/events' className='px-6 py-3 border-2 border-white rounded-lg font-semibold hover:bg-white hover:text-slate-900 transition'>See Events</Link>
          </div>
        </div>
      </section>
      ...
      <section id='about' className='max-w-6xl mx-auto py-20 px-4'>
        <div className='mb-12'>
          <h3 className='text-3xl md:text-4xl font-bold text-slate-900 mb-4'>About ICAN</h3>
        ...
        <div className='grid md:grid-cols-3 gap-8'>
          {/* Card 1 */}
          <div className='p-6 border-l-4 border-red-600 bg-gray-50 rounded-lg hover:shadow-lg transition'>
            <div className='text-3xl mb-3'>🎉</div>
            <h4 className='text-xl font-bold text-slate-900 mb-2'>Community Events</h4>
            <p className='text-gray-700'>Cultural celebrations, festivals, and community gatherings throughout the year.</p>
          </div>

          {/* Card 2 */}
          <div className='p-6 border-l-4 border-amber-600 bg-gray-50 rounded-lg hover:shadow-lg transition'>
            <div className='text-3xl mb-3'>📚</div>
            <h4 className='text-xl font-bold text-slate-900 mb-2'>Educational Programs</h4>
            <p className='text-gray-700'>Wellness initiatives, cultural education, and youth engagement opportunities.</p>
          </div>

          {/* Card 3 */}
          <div className='p-6 border-l-4 border-blue-600 bg-gray-50 rounded-lg hover:shadow-lg transition'>
            <div className='text-3xl mb-3'>🤝</div>
            <h4 className='text-xl font-bold text-slate-900 mb-2'>Support & Networking</h4>
      ...
      <section className='bg-gray-50 border-t border-gray-200 py-20'>
        <div className='max-w-6xl mx-auto px-4'>
          <h3 className='text-3xl md:text-4xl font-bold text-center text-slate-900 mb-12'>Upcoming Events</h3>
          <div className='grid md:grid-cols-3 gap-6'>
            {/* Event Card 1 */}
            <div className='bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition'>
              <div className='text-3xl mb-3'>🪔</div>
              <h4 className='font-bold text-lg text-slate-900 mb-2'>Diwali Night</h4>
              <p className='text-gray-700 text-sm mb-3'>A celebration of lights, food, and performances.</p>
              <p className='text-xs text-red-600 font-semibold'>Nov 1, 2025</p>
            </div>

            {/* Event Card 2 */}
            <div className='bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition'>
              <div className='text-3xl mb-3'>🤲</div>
              <h4 className='font-bold text-lg text-slate-900 mb-2'>Community Meet</h4>
              <p className='text-gray-700 text-sm mb-3'>Monthly meet-up for new arrivals and families.</p>
              <p className='text-xs text-red-600 font-semibold'>Monthly</p>
            </div>

            {/* Event Card 3 */}
            <div className='bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition'>
              <div className='text-3xl mb-3'>🧘</div>
              <h4 className='font-bold text-lg text-slate-900 mb-2'>Yoga & Wellness</h4>
              <p className='text-gray-700 text-sm mb-3'>Free classes for all ages and fitness levels.</p>
              <p className='text-xs text-red-600 font-semibold'>Dates vary</p>
            </div>
          </div>
        </div>
      </section>
